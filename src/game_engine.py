...
class GameEngine:
    ...
    def _validate_move_with_judge(self, proposed_move: str, board: chess.Board, 
        ...
        try:
            ...
            response = chain.invoke({"proposed_move": proposed_move, "legal_moves": str(legal_moves)})
    ...
    def analyze_position(self, board: chess.Board, engine_path: str = None) -> Dict[str, Any]:
        """Analyze a position with Stockfish if available"""
        ...
        try:
            with chess.engine.SimpleEngine.popen_uci(engine_path) as engine:
                ...
                return {
                    "evaluation": info.get("score", chess.engine.PovScore(chess.engine.Cp(0), chess.WHITE)).white().score(),
    ...
    def get_opening_name(self, board: chess.Board) -> str:
        ...
        for move in game.mainline_moves():
            ...
            if len(moves) >= 6:  # First 3 moves for each side
                break
        ...
        return openings.get(first_move, "Unknown Opening")